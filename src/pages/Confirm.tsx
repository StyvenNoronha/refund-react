  ...
  return (
    <div className="bg-gray-500 lg:w-[512px] rounded-xl flex flex-col items-center p-10 gap-6">
      ...
      <p className="text-sm text-gray-200 text-center">
        ...
        setor financeiro irá encontrar em contato com voce
      </p>
      <a href="/" className="p-3 text-center w-full bg-green-100 rounded-2xl text-white hover:bg-green-200 transition ease-linear">Nova solicitação</a>
    </div>
  );
}
